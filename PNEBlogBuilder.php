...
$dir2 = "$file";   
foreach(array_slice((array)glob($dir2),0,1000) as $file2)  
...
$dir3 = "$file2/*";  
foreach(array_slice((array)glob($dir3),0,1000) as $file3)  
...
$dir4 = "$file3/*";  }  
foreach(array_slice((array)glob($dir4),0,1000) as $file4)  
