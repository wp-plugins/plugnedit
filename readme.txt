...
* Lesser NOTE: Plugnedit Visual Editor Post Upgrades! Added LTR / RTL at the table level to support English / arabic and other languages. Better div alignment (more art then science). Added left hand side docked toolbars and Updated divs to support W3s rule naming, updated outdated tags to HTML 5 validation. New Items, Linked Layers for drop shadows.
